...
require([
  ...
  ], function(esriConfig,Map, SceneView, MapView, Graphic, watchUtils,SimpleRenderer,PolygonSymbol3D, ExtrudeSymbol3DLayer, FeatureLayer,Legend,GraphicsLayer, QueryTask,
    Query,) 
  {
   // esriConfig.apiKey = "AAPK2c7001cf63cf4c32bde7e7db7b8e780cO5DpjPOSMxZdJoI4rQ-bXRVoQkZYrShAtQnTEfzo_r8a8ON9UYt-jZ3Pk3PF6k38";
   esriConfig.apiKey = "AAPKf2f682bb06cd4d6db04ec7adc972abd38bcgsUzXDf0Ja0oARVexpNbd3pbtHhBRkgtki3elRuKgs0jX7s6GqnAeuJ9lbtym";
    ...
    var china ="https://services3.arcgis.com/U26uBjSD32d7xvm2/arcgis/rest/services/0508cug_WFL1/FeatureServer/0";
     //创建用于显示查询结果的图形层和符号
    ...
    // 还必须使用addUniqueValueInfo()方法或构造函数中的uniqueValueInfos属性来定义每个类型及其关联的符号。
     const renderer = {  
      ...
      uniqueValueInfos: [
        {
          value: "culandsport",   //餐厅   具有该值的要素将使用给定的符号进行渲染。
          symbol: getSymbol("#A7C636"),   //调用上面的函数，用这个颜色进行渲染
          label: "culandsport"
        },
        {
    ...
    */
    ...
    function setup() //创建一个几何图形,setup是when调用的方法
    {
